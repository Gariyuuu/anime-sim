...
export const aincradGuilds: GuildDefinitionInput[] = [
  {
    ...
    values: "Front-line combat focus. Fast clears, high risk, glory-driven. Ryo expects results, not excuses.",
    leaderNpcId: "ai-ryo",
    color: "#8f2e2e",
  ...
  },
  {
    ...
    values: "Support and survival focus. Small, careful, protective of newer players. Nell won't send anyone into a fight she wouldn't take herself.",
    leaderNpcId: "ai-nell",
    color: "#5b8f6f",
  ...
  },
  {
    ...
    values: "Economic and logistics focus. Crafting, trading, market control. Dask believes surviving Aincrad is a supply problem, not a combat one.",
    leaderNpcId: "ai-dask",
    color: "#6b6b3d",
