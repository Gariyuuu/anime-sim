...
export const aincradItems: ItemDefinitionInput[] = [
  ...
  /* --------------------------------- Floor 11-20 unique drops --------------------------------- */
  { id: "ai-item-archivists-lens", name: "Archivist's Lens", description: "Floor 11 unique drop. Lets its wearer read text that should have dissolved decades ago.", kind: "equipment", slot: "accessory", rarity: "epic", value: 0, icon: "gem", statBonuses: { swordSkill: 5, luck: 3 } },
  { id: "ai-item-foundry-gauntlets", name: "Foundry Gauntlets", description: "Floor 12 unique drop. Still warm to the touch, always.", kind: "equipment", slot: "gloves", rarity: "epic", value: 0, icon: "hand", statBonuses: { attack: 10, defense: 4 } },
  { id: "ai-item-glasswind-cloak", name: "Glasswind Cloak", description: "Floor 13 unique drop. Woven from thread spun out of the reach's own glass sand.", kind: "equipment", slot: "armor", rarity: "epic", value: 0, icon: "shirt", statBonuses: { defense: 12, agility: 8 } },
  { id: "ai-item-bloomguard-charm", name: "Bloomguard Charm", description: "Floor 14 unique drop. Smells faintly of the gardens no matter how far you carry it.", kind: "equipment", slot: "accessory", rarity: "epic", value: 0, icon: "gem", statBonuses: { maxStamina: 20, luck: 2 } },
  { id: "ai-item-duskmarch-banner", name: "Duskmarch Banner", description: "Floor 15's milestone unique drop. Carries every name Corvin's ever recorded.", kind: "equipment", slot: "accessory", rarity: "legendary", value: 0, icon: "flag", statBonuses: { attack: 8, defense: 8, charisma: 4 } },
  { id: "ai-item-dockhand-rig", name: "Dockhand Rig", description: "Floor 16 unique drop. Standard-issue harbor gear, reinforced well past standard.", kind: "equipment", slot: "armor", rarity: "epic", value: 0, icon: "shirt", statBonuses: { defense: 16, attack: 4 } },
  { id: "ai-item-orchard-sickle", name: "Orchard Sickle", description: "Floor 17 unique drop. Cuts in complete silence, same as everything else on this floor.", kind: "equipment", slot: "weapon", rarity: "epic", value: 0, icon: "sword", statBonuses: { attack: 20, agility: 6 } },
  { id: "ai-item-stormwatch-plate", name: "Stormwatch Plate", description: "Floor 18 unique drop. Garrison-forged, built to outlast a siege that never ends.", kind: "equipment", slot: "armor", rarity: "epic", value: 0, icon: "shirt", statBonuses: { defense: 22, agility: -2 } },
  { id: "ai-item-courtiers-signet", name: "Courtier's Signet", description: "Floor 19 unique drop. A ring for a court that never had anyone left to wear it.", kind: "equipment", slot: "accessory", rarity: "epic", value: 0, icon: "gem", statBonuses: { charisma: 6, luck: 4 } },
  { id: "ai-item-spirebreaker-emblem", name: "Spirebreaker Emblem", description: "Floor 20's milestone unique drop. Proof, if anyone ever needs it, that the twentieth floor was cleared.", kind: "equipment", slot: "accessory", rarity: "legendary", value: 0, icon: "gem", statBonuses: { attack: 12, defense: 12, agility: 6, luck: 4 } },
];
