...
export const aincradMaps: MapDefinitionInput[] = [
  ...
  },
  {
    ...
    sceneType: "forest",
    arrivalEffects: [{ type: "setFlag", flag: "ai-flag-floor2-field-entered" }],
    interactables: [
  ...
  },
  {
    ...
    sceneType: "boss",
    arrivalEffects: [{ type: "setFlag", flag: "ai-flag-floor2-boss-entered" }],
    interactables: [
  ...
  },
  {
    ...
    sceneType: "dungeon",
    arrivalEffects: [{ type: "setFlag", flag: "ai-flag-floor3-field-entered" }],
    interactables: [
  ...
  },
  {
    ...
    sceneType: "boss",
    arrivalEffects: [{ type: "setFlag", flag: "ai-flag-floor3-boss-entered" }],
    interactables: [
...
const laterFloorMaps: MapDefinitionInput[] = laterFloorMapSpecs.flatMap((spec): MapDefinitionInput[] => [
  ...
  },
  {
    ...
    sceneType: spec.fieldSceneType,
    arrivalEffects: [{ type: "setFlag", flag: `ai-flag-floor${spec.floor}-field-entered` }],
    interactables: [
